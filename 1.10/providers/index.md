...
See the [Model Catalog](https://pvliesdonk.github.io/image-generation-mcp/1.10/providers/model-catalog/index.md) for narrative guidance on every model — what each is best at, what fights it, prompt grammar examples, and lifecycle status.
