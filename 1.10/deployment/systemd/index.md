...
Edit `/etc/image-generation-mcp/env` to configure the server. All variables use the `IMAGE_GENERATION_MCP_` prefix. See [Configuration](https://pvliesdonk.github.io/image-generation-mcp/1.10/configuration/index.md) for the full reference.
