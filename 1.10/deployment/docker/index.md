...
See [Configuration](https://pvliesdonk.github.io/image-generation-mcp/1.10/configuration/index.md) for the full environment variable reference.

For OIDC auth variables, see [Authentication](https://pvliesdonk.github.io/image-generation-mcp/1.10/guides/authentication/index.md).
