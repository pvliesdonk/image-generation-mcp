...
Gemini models accept a reference image alongside a text prompt via the `transform_image` tool. Use this to edit an existing image by description — for example, replacing a background, changing an object's color, or applying a style change.
