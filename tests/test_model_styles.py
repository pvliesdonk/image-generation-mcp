...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("openai:chatgpt-image-latest", "current"),
        ("openai:dall-e-3", "deprecated"),
        ("openai:dall-e-2", "legacy"),
        ("gemini:gemini-2.5-flash-image", "legacy"),
        ("gemini:gemini-3.1-flash-image", "current"),
        ("gemini:gemini-3-pro-image", "current"),
        ("gemini:gemini-3.1-flash-lite-image", "current"),
