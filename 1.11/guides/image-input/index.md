...
1. A local filesystem path, allowed only when `IMAGE_GENERATION_MCP_ALLOW_LOCAL_FILE_INPUT=true` (off by default). See [Configuration](https://pvliesdonk.github.io/image-generation-mcp/1.11/configuration/index.md).
...
Any image-input provider handles a single reference. See [Gemini](https://pvliesdonk.github.io/image-generation-mcp/1.11/providers/gemini/#image-input-image-to-image), [OpenAI](https://pvliesdonk.github.io/image-generation-mcp/1.11/providers/openai/#image-input-editing-and-composition), and [SD WebUI](https://pvliesdonk.github.io/image-generation-mcp/1.11/providers/sd-webui/#image-input-img2img).
...
See [Gemini multi-image composition](https://pvliesdonk.github.io/image-generation-mcp/1.11/providers/gemini/#multi-image-composition-and-character-consistency).
...
See [OpenAI masks](https://pvliesdonk.github.io/image-generation-mcp/1.11/providers/openai/#masks).
...
See [SD WebUI img2img](https://pvliesdonk.github.io/image-generation-mcp/1.11/providers/sd-webui/#image-input-img2img).

## Related pages

- [Tools: `transform_image`](https://pvliesdonk.github.io/image-generation-mcp/1.11/tools/#transform_image) for the full parameter reference.
- [Image Assets](https://pvliesdonk.github.io/image-generation-mcp/1.11/guides/image-assets/index.md) for how generated images are stored and addressed.
- [Providers overview](https://pvliesdonk.github.io/image-generation-mcp/1.11/providers/index.md) for per-provider detail.
