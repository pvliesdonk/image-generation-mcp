...
For per-model strengths, weaknesses, and prompt examples, see the [Model Catalog](https://pvliesdonk.github.io/image-generation-mcp/1.11/providers/model-catalog/index.md).
