...
See the [Model Catalog](https://pvliesdonk.github.io/image-generation-mcp/1.11/providers/model-catalog/index.md) for narrative guidance on every model: strengths, known weaknesses, prompt grammar examples, and lifecycle status.
